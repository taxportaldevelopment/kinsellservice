    ...
    <div>
            ...
            <div className="service-prov container">
                 ...
                 <div className="row d-flex justify-content-center align-items-center">
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                           <div className="p-3 shadow">
                                <strong className="d-inline brandColor">Fence Installation</strong>
                                <p className="py-2">From broken panels to leaning posts, our repair services ensure your fence remains sturdy and secure.</p>
                           </div>
                      </div>
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                      <div className="p-3 shadow">
                 ...
                 <div className="row d-flex justify-content-center align-items-center">
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                           <div className="p-3 shadow">
                                <strong className="d-inline brandColor">Custom Fencing Solutions</strong>
                                <p className="py-2">Looking for something unique? We design and build custom fences that match your property’s style and meet your specific requirements.</p>
                           </div>
                      </div>
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                      <div className="p-3 shadow">
                                <strong className="d-inline brandColor">Fence Painting & Staining</strong>
                                <p className="py-2">Protect your fence from weather damage and give it a fresh, polished look with our painting and staining services.</p><br />
                           </div>
                      </div>
                 </div>
                 <div className="row d-flex justify-content-center align-items-center">
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                           <div className="p-3 shadow">
                                <strong className="d-inline brandColor">Gate Installation & Repair</strong>
                                <p className="py-2">We also offer gate installation and repair services for added convenience and functionality.</p>
                           </div>
                      </div>
                 </div>
            </div>
                    ...
                    <h2 className="text-center py-3">Why Choose <span className="brandColor">Kinsell</span> Service for Fence Services?</h2>
          
                   <p className="py-1"><strong>Quality Materials</strong> : We use durable, high-quality materials to ensure longevity and performance.</p>
                   <p className="py-1"><strong>Expert Craftsmanship</strong> : Our skilled professionals deliver precise and reliable workmanship.</p>
                   <p className="py-1"><strong>Affordable Pricing</strong> : Get top-tier fence solutions without breaking the bank.</p>
                   <p className="py-1"><strong>Customer Satisfaction</strong> : We work closely with you to bring your vision to life.
                   Transform Your Property Today!</p>
                   <p className="py-1">A well-built fence adds value, security, and style to your property. Whether it’s a new installation, repair, or customization, trust Kinsell Service to deliver outstanding results.</p>

  ...
  return (
    <div>
            ...
            <div className="p-3">
              ...
              <ul type="none">
                <li className="py-2 brand-name ">
                  <FaHandPointRight className="px-1 h4" /> Electrical repairs
                  and installations
                </li>
                <li className="py-2 brand-name">
                  <FaHandPointRight className="px-1 h4" /> Lighting upgrades and
                  fixture installations
                </li>
                <li className="py-2 brand-name">
                  <FaHandPointRight className="px-1 h4" /> Wiring and circuit
                  troubleshooting
                </li>
              </ul>
              <p className="text-style">
                Keep your home’s electrical systems running smoothly with our
                professional electrical services. We offer repairs,
                installations, lighting upgrades, and fixture installations. Our
                team is also skilled in wiring and circuit troubleshooting to
        ...
        <div className="row d-flex justify-content-center align-items-center">
          <div className="col-md-12 col-lg-5 p-3 mt-3">
            <div className="p-3 shadow">
              ...
              <p className="py-2">
                Ensure your property is equipped with safe and efficient
                electrical wiring, whether it’s a new installation or an upgrade
          ...
          <div className="col-md-12 col-lg-5 p-3 mt-3">
            <div className="p-3 shadow">
              ...
              <p className="py-2">
                Brighten your spaces with our expert indoor and outdoor lighting
                solutions, including energy-efficient LED installations and
                custom designs.{" "}
              </p>
            </div>
          </div>
        ...
        <div className="row d-flex justify-content-center align-items-center">
          <div className="col-md-12 col-lg-5 p-3 mt-3">
            <div className="p-3 shadow">
              ...
              <p className="py-2">
                Modernize your electrical panel to handle increased power
                demands and improve your system’s safety and reliability.{" "}
              </p>
            </div>
          </div>
          <div className="col-md-12 col-lg-5 p-3 mt-3">
            <div className="p-3 shadow">
              ...
              <p className="py-2">
                Professional setup and wiring for appliances, ceiling fans, air
        ...
        <div className="row d-flex justify-content-center align-items-center">
          <div className="col-md-12 col-lg-5 p-3 mt-3">
            <div className="p-3 shadow">
              ...
              <p className="py-2">
                Fix faulty switches, outlets, circuits, and other electrical
          ...
          <div className="col-md-12 col-lg-5 p-3 mt-3">
            <div className="p-3 shadow">
              ...
              <p className="py-2">
                Our team is available for urgent repairs to address power
                outages, electrical hazards, or equipment failures.{" "}
              </p>
            </div>
          </div>
          <div className="col-md-12 col-lg-5 p-3 mt-3">
            <div className="p-3 shadow">
              ...
              <p className="py-2">
                Upgrade your home with smart systems, including automated
                lighting, security, and energy management features.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container">
        ...
        <p className="py-1">
          <strong>icensed Electricians</strong> :Our certified professionals
          adhere to all safety standards and building codes.
        </p>
        <p className="py-1">
          <strong>High-Quality Materials</strong> : We use durable and reliable
          components for long-lasting results.
        </p>
        <p className="py-1">
          <strong>Prompt Service</strong> : We minimize disruptions with
          efficient and timely project completion.
        </p>
        <p className="py-1">
          <strong>Customized Solutions</strong> : - Tailored electrical plans to
          meet your specific needs.
        </p>
        <p className="py-1">
          <strong>Affordable Pricing</strong> : Quality service at competitive
          rates.
        </p>
        <h6 className="py-1">Power Up Your Property Today!</h6>
        <p className="py-1">
          From basic repairs to advanced electrical installations, Kinsella
          Service ensures your systems are safe, efficient, and up-to-date.
        </p>
      </div>
    </div>
  );

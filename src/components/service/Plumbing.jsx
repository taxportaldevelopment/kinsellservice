                                             ...
                                             <div className="p-3">
                                                  <h1 className='py-3 brand-name'>Plumbing Services</h1>
                                                    ...
                                                    <p className='text-style'>Ensure your home’s plumbing is in top condition 
                                                        ...
                                                        <p className="text-tyle">Ensure the smooth functioning of your property’s water systems with our reliable and professional Plumbing Services. At Kinsell Service, we provide comprehensive plumbing solutions to meet all your needs, from routine maintenance to emergency repairs. Our skilled plumbers are equipped to handle projects of any size, ensuring your plumbing is efficient, safe, and up to code.</p>
                 ...
                 <div className="row d-flex justify-content-center align-items-center">
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                           <div className="p-3 shadow">
                                ...
                                <p className="py-2">Fix dripping faucets, leaking pipes, and other water issues quickly and efficiently to prevent damage and water waste.</p>
                           </div>
                      </div>
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                      <div className="p-3 shadow">
                                <strong className="d-inline brandColor">Fixture Installation</strong>
                                <p className="py-2">Upgrade your home with the installation of new sinks, faucets, showers, and toilets, combining style with functionality.</p>
                           </div>
                      </div>
                 </div>
                 ...
                 <div className="row d-flex justify-content-center align-items-center">
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                           <div className="p-3 shadow">
                                ...
                                <p className="py-2">Keep your pipes clear and clog-free with our thorough drain cleaning services, restoring smooth water flow.</p>
                           </div>
                      </div>
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                      <div className="p-3 shadow">
                                <strong className="d-inline brandColor">Water Heater Services</strong>
                                <p className="py-2">We install, repair, and maintain water heaters to ensure you always have access to hot water when you need it.</p><br />
                           </div>
                      </div>
                 </div>
                 <div className="row d-flex justify-content-center align-items-center">
                      <div className="col-md-12 col-lg-5 p-3 mt-3">
                           <div className="p-3 shadow">
                                <strong className="d-inline brandColor">Pipe Repairs & Replacements</strong>
                                <p className="py-2">Address issues with corroded or damaged pipes to improve water quality and prevent costly future repairs.</p>
                           </div>
                      </div>
                 </div>
            </div>
                    ...
                    <h2 className="text-center py-3">Why Choose <span className="brandColor">Kinsell</span> Service for Plumbing Services?</h2>
          
                   <p className="py-1"><strong>Experienced Professionals</strong> : Our licensed plumbers bring years of expertise to every job.</p>
                   <p className="py-1"><strong>Fast & Reliable Service</strong> : We work efficiently to resolve your plumbing issues with minimal downtime.</p>
                   <p className="py-1"><strong>Affordable Pricing</strong> : Get quality plumbing solutions at competitive rates</p>
                   <p className="py-1"><strong>Customer-Centric Approach</strong> : Your satisfaction is our top priority, and we tailor our services to meet your specific needs.</p>
                   <p className="py-1">Don’t Let Plumbing Problems Slow You Down!
                   Whether it’s a small leak or a major installation project, Kinsell Service is here to provide top-notch plumbing solutions you can trust.</p>
